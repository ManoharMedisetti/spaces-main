      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed right-0 top-0 h-full w-96 bg-gray-900/95 backdrop-blur-xl border-l border-gray-700/50 z-50 flex flex-col shadow-2xl"
          >
            ...
            <div className="flex-1 overflow-y-auto p-8 space-y-6">
              {context && context.length > 0 ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-400 text-lg">No context sources for this message</p>
                </div>
              )}
            </div>
          </motion.div>
...
function ChatMessage({ message, onShowContext }) {
  ...
  return (
    ...
    >
      ...
      <div className={`max-w-3xl ${isUser ? 'order-first' : ''}`}>
        ...
        {!isUser && message.context && message.context.length > 0 && (
          <button
            ...
            className="flex items-center gap-2 text-xs text-gray-400 hover:text-[#7C5CFC] mt-4 transition-colors font-medium group"
          >
      ...
      {isUser && (
        <div className="w-12 h-12 bg-gradient-to-br from-gray-700 to-gray-800 rounded-2xl flex items-center justify-center flex-shrink-0 border border-gray-600/50">
...
function ChatInput({ onSendMessage, disabled }) {
  ...
  return (
    <div className="sticky bottom-0 bg-[#0A0A0A]/95 backdrop-blur-xl border-t border-gray-800/50 p-8">
        ...
        <div className="flex gap-4 items-end">
          <div className="flex-1 relative">
            <textarea
              ...
              className="w-full px-6 py-5 pr-20 rounded-3xl border border-gray-700/50 focus:border-[#7C5CFC]/50 focus:ring-4 focus:ring-[#7C5CFC]/20 focus:outline-none transition-all duration-200 resize-none min-h-[60px] max-h-[120px] bg-gray-900/80 backdrop-blur-sm text-gray-100 placeholder-gray-500"
              disabled={disabled}
              rows={1}
            />
            <div className="absolute bottom-4 right-6 flex items-center gap-2 text-xs text-gray-500">
        ...
        <div className="max-w-4xl mx-auto p-8 space-y-8">
          ...
          {loading && (
            ...
            >
              ...
              <div className="bg-gray-800/60 border border-gray-700/50 rounded-3xl px-8 py-6 backdrop-blur-sm">
